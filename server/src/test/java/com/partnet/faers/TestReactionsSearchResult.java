...
public class TestReactionsSearchResult 
{
  ...
  public void testRor()
  {
    ReactionCount reactCnt1 = new ReactionCount("DIZZYNESS", 6, 10, 15, 50);
    ...
    ReactionCount reactCnt3 = new ReactionCount("DIZZYNESS", 3, 5, 10, 10);
    Assert.assertEquals(new Double(0), reactCnt3.getRor());
    //tests / by 0: numReports == numReportsEvent
    ReactionCount reactCnt4 = new ReactionCount("DIZZYNESS", 5, 5, 8, 10);
