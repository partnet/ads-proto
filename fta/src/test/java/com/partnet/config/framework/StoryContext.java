...
package com.partnet.config.framework;
...
import com.partnet.page.AdsSite;
import com.partnet.page.AdsSiteProvider;
  ...
  extends AbstractStoryContext
{
  ...
  AdsSiteProvider siteProvider;

  
  @Inject
  StoryContext(final PageProvider pageProvider, final AdsSiteProvider siteProvider)
  {
